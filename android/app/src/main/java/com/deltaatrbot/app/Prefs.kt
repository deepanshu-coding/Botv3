...
class Prefs(context: Context) {
    ...
    var hasPromptedSetup: Boolean
        get() = sp.getBoolean(KEY_HAS_PROMPTED_SETUP, false)
        set(value) = sp.edit().putBoolean(KEY_HAS_PROMPTED_SETUP, value).apply()
    ...
    companion object {
        ...
        private const val KEY_HAS_PROMPTED_SETUP = "has_prompted_setup"
    }
}
